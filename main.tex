...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=10cm,height=\textheight,keepaspectratio]{Figures/logo.png}
\end{figure}
\vspace{2.2cm}
...
\input{Chapters/Chapter2} %contexte and objectif
\input{Chapters/Chapter3} %state of art
\input{Chapters/Chapter4} %program
